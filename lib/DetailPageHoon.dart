...
import 'DetailPageHoon2.dart';
import 'package:just_audio/just_audio.dart'; // just_audio 패키지 임포트
import 'dart:async';

class DetailPageHoon extends StatefulWidget {

  @override
  _DetailPageHoonState createState() => _DetailPageHoonState();
}

class _DetailPageHoonState extends State<DetailPageHoon> {
  ...
  void _playSound() async {
    try {
      await _audioPlayer.setAsset('sounds/Hoon.mp3'); // 음성 파일 경로 설정
        ...
        child: Center(
          child: Column(
            ...
            children: [
              Hero(
                tag: "김성훈",
                child: Image.asset('images/hoon_morning.png',
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => DetailPageHoon2(),
                    ),
                  );
                },
