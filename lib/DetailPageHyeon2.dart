...
class DetailPageHyeon2 extends StatelessWidget {
  @override
        ...
        child: Center(
          child: Column(
            ...
            children: [
              Hero(
                tag: "양현",
                child: Image.asset('images/hyeon_night.png',
    ...
    _timer = Timer.periodic(_decreaseInterval, (timer) {
      if (_gaugeValue > 0 && _gaugeValue < 1.0) {
        ...
        Future.delayed(Duration(seconds: 1), () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => DetailPageHyeon()), // DetailPageRam으로 이동
          );
        });
      }
    });
